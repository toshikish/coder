...
type DRPCInsightDaemonClient interface {
	...
	RecordInvocation(ctx context.Context, in *Invocation) (*Empty, error)
...
func (c *drpcInsightDaemonClient) RecordInvocation(ctx context.Context, in *Invocation) (*Empty, error) {
	out := new(Empty)
...
type DRPCInsightDaemonServer interface {
	RecordInvocation(context.Context, *Invocation) (*Empty, error)
	ReportPath(context.Context, *ReportPathRequest) (*Empty, error)
}

type DRPCInsightDaemonUnimplementedServer struct{}

func (s *DRPCInsightDaemonUnimplementedServer) RecordInvocation(context.Context, *Invocation) (*Empty, error) {
...
func (DRPCInsightDaemonDescription) NumMethods() int { return 2 }
